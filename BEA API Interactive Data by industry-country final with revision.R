...
#must input your own user ID to run successfully
...
Missing_data2 <- Missing_data[ , -which(names(Missing_data) %in% c("TypeOfService", "Affiliation", "Identifier", "Unique_ID"))]
